...
-- Tiempo de generación: 08-11-2023 a las 11:40:38
...
CREATE TABLE IF NOT EXISTS `lotes` (
  ...
  `nombre_lote` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `descripcion` varchar(255) NOT NULL,
  `tipo_lote` enum('pequeño','mediano','grande','') NOT NULL,
